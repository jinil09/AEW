...
function passFun(){
    ...
    const p1=document.getElementById("passwordsec")
    const m1=document.getElementById("mainSection")

    if(p=="9427")
    {
        p1.setAttribute("style","display:none")
        m1.setAttribute("style","display:block")  
    }

    else{alert("Please Enter Correct Password To Accesss")}
}
